...
#SBATCH --job-name=alfworld-qwen3-4b-rl-wt
...
export ALFWORLD_TRAJ_DUMP_DIR="${UPSTREAM_VERL}/trajectories/qwen3_4b_rl_wt_$(date +%Y%m%d_%H%M%S)"
...
# Run with Qwen3-4B override + enable_thinking=False (no_think mode) —
...
bash "${ALFWORLD_RECIPE}/run_alfworld.sh" \
    ...
    trainer.experiment_name=agent_loop_qwen3_4b_rl_with_think

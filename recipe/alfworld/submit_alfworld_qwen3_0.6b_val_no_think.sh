...
#SBATCH --job-name=alfworld-qwen3-0.6b-val-nt
...
export ALFWORLD_TRAJ_DUMP_DIR="${UPSTREAM_VERL}/trajectories/qwen3_0.6b_val_nt_$(date +%Y%m%d_%H%M%S)"
...
bash "${ALFWORLD_RECIPE}/run_alfworld.sh" \
    ...
    trainer.experiment_name=agent_loop_qwen3_0.6b_val_no_think

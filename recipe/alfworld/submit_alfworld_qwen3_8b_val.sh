...
#
# Usage:
#   sbatch recipe/alfworld/submit_alfworld_qwen3_8b_val.sh
# =============================================================================

#SBATCH --job-name=alfworld-qwen3-8b-val
...
export ALFWORLD_TRAJ_DUMP_DIR="${UPSTREAM_VERL}/trajectories/qwen3_8b_val_$(date +%Y%m%d_%H%M%S)"
...
# Run with Qwen3-8B override. Leave enable_thinking at default True:
...
bash "${ALFWORLD_RECIPE}/run_alfworld.sh" \
    ...
    trainer.experiment_name=agent_loop_qwen3_8b_val_only

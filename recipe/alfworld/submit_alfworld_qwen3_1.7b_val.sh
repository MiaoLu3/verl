...
#SBATCH --job-name=alfworld-qwen3-1.7b-val
...
export ALFWORLD_TRAJ_DUMP_DIR="${UPSTREAM_VERL}/trajectories/qwen3_1.7b_val_$(date +%Y%m%d_%H%M%S)"
...
bash "${ALFWORLD_RECIPE}/run_alfworld.sh" \
    ...
    trainer.experiment_name=agent_loop_qwen3_1.7b_val_only
